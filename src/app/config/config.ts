export const config = {
    ...
    'roles':  {'HR': ['/core/setting/emailtemplate', '/core/setting/emailvariable', '/core/setting/tagsetting', '/core/setting/automaticTags', '/core/setting/jobProfileTags', '/core/inbox', '/core/setting/resetPassword', '/core/dashboard'], 'Guest': [ '/core/inbox', '/core/setting/resetPassword']},
    'dashboardChartColor': ['#fe0000', '#00aedb', '#a200ff', '#f47835', '#d41243', '#4b86b4', '#419873', '#398564', '#317256']
};
